...
<div class="login-wrapper" style="background-image: url(dashboard/img/mp-bg.jpg)">
    <section class="first-sub_wrapper">
        ...
        <div class="login-form_container pane-white text-center">
            <form class="" action="https://mypadi.ng/register" method="post">
            ...
            <div class="form-group">
                    <input type="submit" role="button" class="btn btn-lg btn-block btn-secondary" href="/dashboard" value="REGISTER">
                </div>
                <br>
    ...
    <section class="second-sub_wrapper">
        <div class="inner">
            <div class="inner">
               <p class="pull-right"> Already have an account ? <a href="" class="btn btn-success">Login</a></p>
            </div>
        </div>
    </section>
</div>
